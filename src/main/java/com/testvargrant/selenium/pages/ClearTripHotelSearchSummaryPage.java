 ...
 * ********History Card***************
 * 
 * File: ClearTripHotelSearchSummaryPage.java
 * 
 * Created By      Date 
 * ======================================================
...
/*
 * This page class is used to perform the actions in Clear Trip Hotel Search Summary Page
 */
public class ClearTripHotelSearchSummaryPage extends BasePage{
	
	public WebDriver webDriver;
	
	//Page Objects in the Clear Trip Hotel Search Summary Page
	...
	public ClearTripHotelSearchSummaryPage(WebDriver webDriver) {
		super(webDriver);
